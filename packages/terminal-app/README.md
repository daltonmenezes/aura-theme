...
<p align="center">
✨ A beautiful dark theme for Terminal.app and another apps
  <br><br>
...
<p align="center">
  <img alt="preview" src="https://github.com/daltonmenezes/assets/blob/master/images/aura-theme/aura-terminal-app-preview.png?raw=true" />
</p>
...
5. Select the `aura-theme.terminal` file
6. Select the `aura-theme` in the list and make it as default.
