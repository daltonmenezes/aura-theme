...
# Installation
1. Download the [theme.tdesktop-theme](https://raw.githubusercontent.com/{{ author.username }}/{{ slug }}/blob/main/packages/telegram/theme.tdesktop-theme.zip?raw=true) file
